...
export default {
  ...
  brand: {
    ...
    feature2: "Invoice and get paid",
    feature3: "Online payments coming soon",
...
home: {
  ...
  features: {
    ...
    payments: {
      ...
      desc: "Display your bank details right on your quotes and invoices so clients can pay you by bank transfer. Online card payments are coming soon.",
      bullet1: "Bank details on your invoices",
      bullet2: "Card payments — coming soon",
      bullet3: "Automatic payment status tracking",
      visual: {
        title: "Payment Breakdown",
        amount: "Invoice Amount",
        bankLabel: "Account Holder",
        ibanLabel: "IBAN",
        receive: "YOU RECEIVE",
      },
    },
...
payments: {
  ...
  connect: {
    ...
    openDashboard: "Open Stripe Dashboard",
    notConnectedBody: "Online card payment is coming soon. In the meantime, display your IBAN on your quotes and invoices so clients can pay you by bank transfer.",
    connectAccountBtn: "Connect Stripe Account",
  ...
  howItWorks: {
    ...
    step1: {
      ...
      desc: "Your IBAN automatically appears on the quote or invoice sent to your client.",
    },
    step2: {
      title: "2. Client pays by bank transfer",
      desc: "Your client makes the bank transfer directly from their bank, using the details shown.",
    },
    step3: {
      title: "3. You mark it as paid",
      desc: "Once you receive the transfer, simply mark the invoice as paid in Vimen.",
    },
    step4: {
      title: "4. Card payment — coming soon",
      desc: "Online card payment is coming soon, for even faster collection.",
    },
  },
  table: {
    date: "Date",
...
faqPage: {
  ...
  q3: { question: "How do payments work", answer: "You can display your IBAN on your quotes and invoices so clients can pay you by bank transfer. Online card payments are coming soon." },
  q4: { question: "How do clients know what to pay and where", answer: "Your bank details (IBAN) automatically appear on every quote and invoice you send, along with the exact amount due." },
  ...
  q9: { question: "Is my data secure", answer: "Your data is stored securely and access is protected by authentication on every account. Your bank details are only visible to you and your clients, on your own documents." },
...
publicQuote: {
  ...
  pricingPage: {
    ...
    plans: {
      free: {
        ...
        feat3: "Bank transfer (IBAN) — card payments coming soon",
    ...
    faq: {
      ...
      a2: "You can display your bank details (IBAN) on your quotes and invoices so clients can pay you by bank transfer. Online card payments are coming soon.",
      q3: "Are there any hidden fees?",
      a3: "No. Vimen doesn't take any commission on your payments, now or once card payments become available.",
  ...
  publicBooking: {
    ownerPreviewNotice: "This is a preview of the booking page your clients see. You can't submit a request to yourself — share the link below with clients instead.",
    copiedLabel: "Copied!",
    copyLinkBtn: "Copy link",
    pageNotFound: "Page not found",
    loadErrorWhat: "Couldn't load this booking page",
    loadErrorWhy: "This is usually a temporary connection issue, not a problem with the link itself.",
    tryAgain: "Try again",
    noSlotsThisDay: "No available slots for this day.",
    uploading: "Uploading...",
    dropImage: "Drop image or tap to upload",
    imageFormats: "JPG, PNG up to 10MB",
    photoUploaded: "Photo uploaded",
    attachPhotoLabel: "Attach photo or file (optional)",
    attachPhotoHint: "Show us the problem or area to help the professional prepare.",
    selectedLabel: "Selected",
    depositRequiredFixed: "Deposit required: {{amount}}",
    depositRequiredPercent: "Deposit required: {{percent}}% ({{amount}})",
    stepService: "Service",
    stepDateTime: "Date & time",
    stepDetails: "Your details",
    chooseServiceTitle: "Choose a service",
    chooseServiceSub: "Select what you'd like to book, or choose \"Something else\".",
    somethingElse: "Something else",
    somethingElseSub: "Describe a custom request",
    continueBtn: "Continue →",
    backBtn: "← Back",
    pickDateTimeTitle: "Pick a date & time",
    slotsShownFor: "Slots shown for {{minutes}} minute sessions.",
    choosePreferredSlot: "Choose your preferred slot.",
    noAvailabilitySet: "This professional hasn't set their availability yet.",
    contactDirectly: "Please contact them directly to arrange a time.",
    changeBtn: "Change",
    atTime: "at",
    yourDetailsTitle: "Your details",
    yourDetailsSub: "Enter your contact information so {{name}} can reach you.",
    nameLabel: "Your Name *",
    emailLabel: "Email Address *",
    phoneLabel: "Phone Number",
    notesLabel: "Notes or Instructions",
    ownPageBtn: "This is your own page",
    sendingRequestBtn: "Sending request...",
    requestBookingBtn: "Request Booking",
    requestSentTitle: "Request sent!",
    requestSentBodySlot: "{{name}} will confirm your {{slot}} slot shortly.",
    requestSentBodyGeneric: "{{name}} will confirm your request shortly.",
    depositOnConfirmFixed: "A deposit of {{amount}} will be requested once your booking is confirmed.",
    depositOnConfirmPercent: "A deposit of {{percent}}% ({{amount}}) will be requested once your booking is confirmed.",
