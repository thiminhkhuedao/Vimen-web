...
export default {
  ...
  auth: {
    ...
    feature3:          "Paiements en ligne bientôt disponibles",
  ...
  settings: {
    ...
    privacyControls: {
      ...
      exportDesc:       "Télécharge une copie complète de toutes tes données personnelles stockées sur Vimen (profil, clients, factures, avis, etc.) au format JSON.",
      exportBtn:        "Télécharger mes données",
      exporting:        "Export en cours...",
      exportError:      "Impossible d'exporter tes données pour le moment. Réessaie ou contacte le support.",
      deleteTitle:      "Supprimer mon compte",
      deleteDesc:       "Action définitive et irréversible. Supprime ton profil, tous tes clients, factures, avis, réservations, et ton compte de connexion. Aucune récupération possible après.",
      deleteBtn:        "Supprimer mon compte",
      confirmWord:      "SUPPRIMER",
      confirmLabel:     "Tape {{word}} pour confirmer :",
      deleting:         "Suppression...",
      deleteConfirmBtn: "Supprimer définitivement",
      deleteError:      "Impossible de supprimer ton compte pour le moment. Contacte contact.vimen@gmail.com pour qu'on le fasse manuellement.",
    },
    account:          "Compte",
    payment:          "Paiement",
...
home: {
  ...
  features: {
    ...
    payments: {
      tabLabel: "Paiements",
      title: "Faites-vous payer, simplement",
      desc: "Affichez votre IBAN directement sur vos devis et factures pour que vos clients vous règlent par virement bancaire. Le paiement par carte en ligne arrive bientôt.",
      bullet1: "Coordonnées bancaires sur vos factures",
      bullet2: "Paiement par carte — bientôt disponible",
...
payments: {
  ...
  connect: {
    ...
    openDashboard: "Ouvrir le tableau de bord Stripe",
    notConnectedBody: "Le paiement en ligne par carte bancaire arrive bientôt. En attendant, affichez votre IBAN sur vos devis et factures pour que vos clients vous règlent par virement.",
  ...
  howItWorks: {
    ...
    step1: {
      ...
      desc: "Votre IBAN apparaît automatiquement sur le devis ou la facture envoyée à votre client.",
    },
    step2: {
      title: "2. Le client vous règle par virement",
      desc: "Votre client effectue le virement bancaire directement depuis sa banque, en utilisant les coordonnées affichées.",
    },
    step3: {
      title: "3. Vous marquez la facture payée",
      desc: "Une fois le virement reçu sur votre compte, marquez simplement la facture comme payée dans Vimen.",
    },
    step4: {
      title: "4. Paiement par carte — bientôt disponible",
      desc: "Le règlement en ligne par carte bancaire arrive prochainement, pour un encaissement encore plus rapide.",
    },
  },
  table: {
    date: "Date",
...
faqPage: {
  ...
  q3: { question: "Comment fonctionnent les paiements", answer: "Vous pouvez afficher votre IBAN sur vos devis et factures pour que vos clients vous règlent par virement bancaire. Le paiement en ligne par carte arrive bientôt." },
  q4: { question: "Comment mes clients savent-ils quoi payer et où", answer: "Vos coordonnées bancaires (IBAN) apparaissent automatiquement sur chaque devis et facture que vous envoyez, avec le montant exact à régler." },
  ...
  q9: { question: "Mes données sont elles sécurisées", answer: "Vos données sont stockées de manière sécurisée et l'accès est protégé par authentification sur chaque compte. Vos coordonnées bancaires ne sont visibles que par vous et vos clients, sur vos propres documents." },
...
publicQuote: {
  ...
  pricingPage: {
    ...
    plans: {
      free: {
        ...
        feat3: "Virement bancaire (IBAN) — paiement par carte bientôt disponible",
    ...
    faq: {
      ...
      a2: "Vous pouvez afficher vos coordonnées bancaires (IBAN) sur vos devis et factures pour que vos clients vous règlent par virement. Le paiement en ligne par carte arrive bientôt.",
      q3: "Y a-t-il des commissions cachées ?",
      a3: "Non. Vimen ne prend aucune commission sur vos paiements, ni maintenant ni une fois le paiement par carte disponible.",
  ...
  publicBooking: {
    ownerPreviewNotice: "Ceci est un aperçu de la page de réservation que voient vos clients. Vous ne pouvez pas vous envoyer une demande à vous-même — partagez plutôt le lien ci-dessous à vos clients.",
    copiedLabel: "Copié !",
    copyLinkBtn: "Copier le lien",
    pageNotFound: "Page introuvable",
    loadErrorWhat: "Impossible de charger cette page de réservation",
    loadErrorWhy: "C'est généralement un problème de connexion temporaire, pas un souci avec le lien lui-même.",
    tryAgain: "Réessayer",
    noSlotsThisDay: "Aucun créneau disponible ce jour-là.",
    uploading: "Envoi en cours...",
    dropImage: "Déposez une image ou appuyez pour en ajouter une",
    imageFormats: "JPG, PNG jusqu'à 10 Mo",
    photoUploaded: "Photo ajoutée",
    attachPhotoLabel: "Joindre une photo ou un fichier (optionnel)",
    attachPhotoHint: "Montrez-nous le problème ou la zone concernée pour aider le professionnel à se préparer.",
    selectedLabel: "Sélectionné",
    depositRequiredFixed: "Acompte requis : {{amount}}",
    depositRequiredPercent: "Acompte requis : {{percent}}% ({{amount}})",
    stepService: "Service",
    stepDateTime: "Date & heure",
    stepDetails: "Vos coordonnées",
    chooseServiceTitle: "Choisissez un service",
    chooseServiceSub: "Sélectionnez ce que vous souhaitez réserver, ou choisissez \"Autre chose\".",
    somethingElse: "Autre chose",
    somethingElseSub: "Décrivez votre demande",
    continueBtn: "Continuer →",
    backBtn: "← Retour",
    pickDateTimeTitle: "Choisissez une date & un horaire",
    slotsShownFor: "Créneaux affichés pour des séances de {{minutes}} minutes.",
    choosePreferredSlot: "Choisissez votre créneau préféré.",
    noAvailabilitySet: "Ce professionnel n'a pas encore défini ses disponibilités.",
    contactDirectly: "Merci de le contacter directement pour convenir d'un horaire.",
    changeBtn: "Modifier",
    atTime: "à",
    yourDetailsTitle: "Vos coordonnées",
    yourDetailsSub: "Indiquez vos coordonnées pour que {{name}} puisse vous joindre.",
    nameLabel: "Votre nom *",
    emailLabel: "Adresse e-mail *",
    phoneLabel: "Numéro de téléphone",
    notesLabel: "Notes ou instructions",
    ownPageBtn: "Ceci est votre propre page",
    sendingRequestBtn: "Envoi de la demande...",
    requestBookingBtn: "Envoyer la demande",
    requestSentTitle: "Demande envoyée !",
    requestSentBodySlot: "{{name}} confirmera votre créneau du {{slot}} sous peu.",
    requestSentBodyGeneric: "{{name}} confirmera votre demande sous peu.",
    depositOnConfirmFixed: "Un acompte de {{amount}} vous sera demandé une fois votre réservation confirmée.",
    depositOnConfirmPercent: "Un acompte de {{percent}}% ({{amount}}) vous sera demandé une fois votre réservation confirmée.",
